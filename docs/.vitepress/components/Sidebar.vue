...
import VPSidebarItem from '../../../node_modules/vitepress/dist/client/theme-default/components/VPSidebarItem.vue'
...
<template>
  ...
  >
    ...
    <nav class="nav" id="VPSidebarNav" aria-labelledby="sidebar-aria-label" tabindex="-1">
      ...
      <div v-for="item in sidebarGroups" :key="item.text" class="sidebarGroup">
