...
Size of minified version of Csslandia is 117kb, it’s equall to atound 8,900 lines of unminified CSS. It’s not a big deal to load this entire file, but if you want to remove unused CSS, you can use [PurgeCSS](https://purgecss.com/).
